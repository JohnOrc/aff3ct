/*!
 * \file
 * \brief Class tools::Pattern_polar_t4.
 */
#ifndef PATTERN_POLAR_T4_HPP_
#define PATTERN_POLAR_T4_HPP_
...
namespace tools
{
class Pattern_polar_t4 : public Pattern_polar_i
{
protected:
	inline Pattern_polar_t4(const int &N, const Binary_node<Pattern_polar_i>* node,
	                         const int min_level = 2, const int max_level = -1);

public:
	inline Pattern_polar_t4(const int min_level = 2, const int max_level = -1);

	virtual inline Pattern_polar_t4* alloc(const int &N, const Binary_node<Pattern_polar_i>* node) const;

	virtual ~Pattern_polar_t4() = default;
...
#include "Tools/Code/Polar/Patterns/Pattern_polar_t4.hxx"
#endif

#endif /* PATTERN_POLAR_T4_HPP_ */
