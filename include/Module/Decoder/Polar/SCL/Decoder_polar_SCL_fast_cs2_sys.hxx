...
Decoder_polar_SCL_fast_cs2_sys<B,R,API_polar>
...
//sorter_simd      (N),
  ...
  l_tmp            (N)
{
	const std::string name = "Decoder_polar_SCL_fast_cs2_sys";
	this->set_name(name);
...
template <typename B, typename R, class API_polar>
Decoder_polar_SCL_fast_cs2_sys<B,R,API_polar>
::~Decoder_polar_SCL_fast_cs2_sys()
{
}

template <typename B, typename R, class API_polar>
Decoder_polar_SCL_fast_cs2_sys<B,R,API_polar>* Decoder_polar_SCL_fast_cs2_sys<B,R,API_polar>
::clone() const
{
	auto m = new Decoder_polar_SCL_fast_cs2_sys(*this);
	m->deep_copy(*this);
	return m;
}

template <typename B, typename R, class API_polar>
void Decoder_polar_SCL_fast_cs2_sys<B,R,API_polar>
...
template <typename B, typename R, class API_polar>
const std::vector<bool>& Decoder_polar_SCL_fast_cs2_sys<B,R,API_polar>
...
template <typename B, typename R, class API_polar>
int Decoder_polar_SCL_fast_cs2_sys<B,R,API_polar>
