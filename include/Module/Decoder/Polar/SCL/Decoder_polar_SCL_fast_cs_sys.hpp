/*!
 * \file
 * \brief Class module::Decoder_polar_SCL_fast_cs_sys.
 */
#ifndef DECODER_POLAR_SCL_FAST_CS_SYS
#define DECODER_POLAR_SCL_FAST_CS_SYS
...
template <typename B = int, typename R = float,
          class API_polar = tools::API_polar_dynamic_seq<B, R, tools::f_LLR <  R>,
                                                               ...
                                                               tools::h_LLR <B,R>,
                                                               tools::xo_STD<B  >>>
class Decoder_polar_SCL_fast_cs_sys : public Decoder_SIHO<B,R>, public tools::Interface_get_set_frozen_bits
{
protected:
...
public:
	...
	virtual ~Decoder_polar_SCL_fast_cs_sys();

	virtual Decoder_polar_SCL_fast_cs_sys<B,R,API_polar>* clone() const;
...
#include "Module/Decoder/Polar/SCL/Decoder_polar_SCL_fast_cs_sys.hxx"
#endif

#endif /* DECODER_POLAR_SCL_FAST_CS_SYS_ */
