...
::update_paths_r1(const int r_d, const int off_l, const int off_s, const int n_elmts)
{
	...
	else
	{
		...
		for (auto i = 0; i < n_active_paths; i++)
		{
			...
			update_r1_vec(path, n_elmts, L, c_num, pen);
		}
...
::update_paths_spc(const int r_d, const int off_l, const int off_s, const int n_elmts)
{
	...
	for (auto i = 0; i < n_active_paths; i++)
	{
		...
		update_spc_vec(path, n_elmts, L, c_num, pen);
	}
...
template <typename B, typename R, class API_polar>
void Decoder_polar_SCL_mcfast_sys<B,R,API_polar>
::update_r1_vec(const int path, const int n_elmts, const int L, const int c_num, const std::vector<R>& pen)
{
	switch (L)
	{
	case 2:
...
template <typename B, typename R, class API_polar>
void Decoder_polar_SCL_mcfast_sys<B,R,API_polar>
::update_spc_vec(const int path, const int n_elmts, const int L, const int c_num, const std::vector<R>& pen)
{
	switch (L)
	{
	case 2:
