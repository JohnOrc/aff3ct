/*!
 * \file
 * \brief Class module::Decoder_polar_SCL_mcfast_CA_sys.
 */
#ifndef DECODER_POLAR_SCL_MCFAST_SYS_CA
#define DECODER_POLAR_SCL_MCFAST_SYS_CA
...
template <typename B = int, typename R = float,
          class API_polar = tools::API_polar_dynamic_seq<B, R, tools::f_LLR <  R>,
                                                               ...
                                                               tools::h_LLR <B,R>,
                                                               tools::xo_STD<B  >>>
class Decoder_polar_SCL_mcfast_CA_sys : public Decoder_polar_SCL_mcfast_sys<B,R,API_polar>
{
private:
	bool fast_store;
...
public:
	...
	virtual ~Decoder_polar_SCL_mcfast_CA_sys() = default;

	virtual Decoder_polar_SCL_mcfast_CA_sys<B,R,API_polar>* clone() const;

protected:
	virtual void deep_copy(const Decoder_polar_SCL_mcfast_CA_sys<B,R,API_polar> &m);
